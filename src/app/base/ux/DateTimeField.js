 ...
 */
Ext.define('Tool.base.ux.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.datetimefield',
    requires: ['Tool.base.ux.DateTimePicker'],
    ...
    createPicker: function() {
        ...
        return Ext.create('Tool.base.ux.DateTimePicker', Ext.merge(initialConfig, parentConfig));
    },
